...
<acme:list>
	...
	<acme:list-column code="spokesperson.campaign.list.label.startmoment" path="startMoment" width="25%"/>
	<acme:list-column code="spokesperson.campaign.list.label.endmoment" path="endMoment" width="25%"/>
